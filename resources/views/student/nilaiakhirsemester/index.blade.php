                                ...
                                <table class="table table-bordered table-striped">
                                    <thead class="bg-info">
                                        <tr>
                                            ...
                                            <th class="text-center" rowspan="2" style="width: 28%;">Mata Pelajaran
                                            </th>
                                            <th class="text-center" rowspan="2" style="width: 7%;">KKM</th>
                                            <th class="text-center" colspan="2" style="width: 15%;">Nilai Akhir</th>
                                            </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php $no = 0; ?>
                                        @foreach ($data_pembelajaran->sortBy('subject.subject_name') as $pembelajaran)
                                            <?php $no++; ?>
                                            <tr>
                                                ...
                                                @if (!is_null($pembelajaran->nilai))
                                                    ...
                                                    <td class="text-center">
                                                        {{ $pembelajaran->nilai->nilai_sumatif }}</td>
                                                    <td class="text-center">
                                                        {{ $pembelajaran->nilai->predikat }}</td>
                                                    </td>
                                                @else
