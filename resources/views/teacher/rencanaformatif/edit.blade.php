            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{ route('rencanaformatif.index') }}">Rencana Penilaian
                                Formatif</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('rencanaformatif.update', $pembelajaran->id) }}" method="POST">
                                {{ method_field('PATCH') }}
                                @csrf
                                ...
                                <div class="alert alert-warning alert-dismissible">
                                    ...
                                    <p>Jika KD yang tampil tidak sesuai, silahkan cek dan lakukan mapping semester pada
                                        menu
                                        <a href="{{ route('ck.index') }}">Data Kompetensi Dasar</a>
                                    </p>
                                </div>
                        </div>
