            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{ route('ck.index') }}">Data Capaian Kompetensi</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="callout callout-info">
                                <form action="{{ route('ck.create') }}" method="GET">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="tingkatan_kelas" class="col-sm-2 col-form-label">Tingkatan
                                            Kelas</label>
                                        <div class="col-sm-4">
                            ...
                            <form id="dynamic_form" action="{{ route('ck.store') }}" method="POST">
                                @csrf
                        ...
                        <div class="card-footer clearfix">
                            ...
                            <a href="{{ route('ck.index') }}" class="btn btn-default float-right mr-2">Batal</a>
                        </div>
                        </form>
                    </div>
                    <!-- /.card -->
