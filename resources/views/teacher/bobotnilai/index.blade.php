                                ...
                                <table class="table table-bordered table-hover">
                                    <thead class="bg-success">
                                        <tr>
                                            ...
                                            <th colspan="3" class="text-center" style="width: 300px">Bobot Penilaian
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data_rencana_bobot_nilai as $bobot_nilai)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $bobot_nilai->subject->subject_name }}</td>
                                                <td class="text-center">{{ $bobot_nilai->kelas->class_name }}</td>

                                                @if (is_null($bobot_nilai->bobot_sumatif))
                                                ...
                                                @else
                                                    <td class="text-center">
                                                        <span
                                                            class="badge badge-success">{{ $bobot_nilai->bobot_sumatif }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span
                                                            class="badge badge-success">{{ $bobot_nilai->bobot_pts }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span
                                                            class="badge badge-success">{{ $bobot_nilai->bobot_pas }}</span>
                                                    </td>
                                                @endif
                                                ...
                                                @if (is_null($bobot_nilai->bobot_sumatif))
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-sm btn-primary"
                                                            data-toggle="modal"
                                                            data-target="#modal-tambah{{ $bobot_nilai->id }}">
                                                    ...
                                                    <div class="modal fade" id="modal-tambah{{ $bobot_nilai->id }}">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ route('bobotnilai.store') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="pembelajaran_id"
                                                                            value="{{ $bobot_nilai->id }}">
                                                                        <div class="row">
                                                                            <div class="col-sm-4">
                                                ...
                                                @else
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-sm btn-warning"
                                                            data-toggle="modal"
                                                            data-target="#modal-edit{{ $bobot_nilai->id }}">
                                                    ...
                                                    <div class="modal fade" id="modal-edit{{ $bobot_nilai->id }}">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('bobotnilai.update', $bobot_nilai->id) }}"
                                                                    method="POST">
                                                                    {{ method_field('PATCH') }}
                                                                    @csrf
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        class="form-control"
                                                                                        name="bobot_ph"
                                                                                        value="{{ $bobot_nilai->bobot_sumatif }}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-4">
                                                                                <div class="form-group">
