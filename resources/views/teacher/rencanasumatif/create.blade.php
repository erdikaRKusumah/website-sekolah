            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{ route('rencanasumatif.index') }}">Rencana Penilaian
                                Sumatif</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="callout callout-info">
                                <form action="{{ route('rencanasumatif.create') }}" method="GET">
                                    ...
                                    <div class="form-group row">
                                        <label for="pembelajaran_id" class="col-sm-2 col-form-label">Mata
                                            Pelajaran</label>
                                        <div class="col-sm-10">
                                            <input type="hidden" name="pembelajaran_id"
                                                value="{{ $pembelajaran->id }}">
                                            <input type="text" class="form-control"
                                                value="{{ $pembelajaran->subject->subject_name }} {{ $pembelajaran->kelas->class_name }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jumlah_penilaian" class="col-sm-2 col-form-label">Jumlah
                                            Penilaian</label>
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="jumlah_penilaian"
                                                style="width: 100%;" required onchange="this.form.submit();">
                                                <option value="" disabled>-- Pilih Jumlah Penilaian --</option>
                                                @for ($i = 1; $i <= 20; $i++)
                                                    <option value="{{ $i }}"
                                                        @if ($i == $jumlah_penilaian) selected @endif>
                                                        {{ $i }}</option>
                                                @endfor
                                            </select>
                                        </div>
                            ...
                            <form action="{{ route('rencanasumatif.store') }}" method="POST">
                                @csrf
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr class="bg-primary">
                                                ...
                                                @for ($i = 1; $i <= $jumlah_penilaian; $i++)
                                                    <td>
                                                        <select class="form-control" name="teknik_penilaian[]"
                                                ...
                                                @for ($i = 1; $i <= $jumlah_penilaian; $i++)
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            name="bobot_teknik_penilaian[]" value="1" required
                                            ...
                                            @foreach ($data_kd as $kd)
                                                <tr>
                                                    <td><small><b>{{ $kd->kode_kd }}</b>
                                                            {{ $kd->ringkasan_kompetensi }}</small></td>
                                ...
                                <div class="alert alert-warning alert-dismissible">
                                    ...
                                    <p>Jika KD yang tampil tidak sesuai, silahkan cek dan lakukan mapping semester pada
                                        menu
                                        <a href="{{ route('rencanasumatif.index') }}">Data Kompetensi Dasar</a>
                                    </p>
                                </div>
                        </div>
                        ...
                        <div class="card-footer clearfix">
                            ...
                            <a href="{{ route('rencanasumatif.index') }}"
