                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('nilaisumatif.store') }}" method="POST">
                                @csrf
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="bg-primary">
                                            <tr>
                                                ...
                                                <th colspan="{{ $count_kd }}" class="text-center">Kompetensi</th>
                                            </tr>
                                            <tr>
                                                @foreach ($data_rencana_penilaian as $rencana_penilaian)
                                                    <input type="hidden" name="rencana_penilaian_sumatif_id[]"
                                                        value="{{ $rencana_penilaian->id }}">
                                                    <td style="width: 300px;">
                                                        <small><b>{{ $rencana_penilaian->kd_mapel->kode_kd }}</b>
                                                            {{ $rencana_penilaian->kd_mapel->ringkasan_kompetensi }}</small>
                                                    </td>
                                                @endforeach
                                            </tr>
                                        </thead>
