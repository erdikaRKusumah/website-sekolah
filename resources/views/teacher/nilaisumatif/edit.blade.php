            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{ route('nilaisumatif.index') }}">Input Nilai</a>
                        </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="callout callout-info">
                                <form action="{{ route('nilaisumatif.create') }}" method="GET">
                                    @csrf
                            ...
                            <form action="{{ route('nilaisumatif.update', $pembelajaran->id) }}" method="POST">
                                {{ method_field('PATCH') }}
                                @csrf
                                        ...
                                        <thead class="bg-primary">
                                            ...
                                            <tr>
                                                @foreach ($data_kd_nilai as $kd_nilai)
                                                    <input type="hidden" name="rencana_penilaian_sumatif_id[]"
                                                        value="{{ $kd_nilai->rencana_penilaian_sumatif_id }}">
                                                    <td style="width: 300px;">
                                                        <small><b>{{ $kd_nilai->rencana_penilaian_sumatif->kd_mapel->kode_kd }}</b>
                                                            {{ $kd_nilai->rencana_penilaian_sumatif->kd_mapel->ringkasan_kompetensi }}</small>
                                                    </td>
                                                @endforeach
                                            </tr>
                                        </thead>
                        ...
                        <div class="card-footer clearfix">
                            ...
                            <a href="{{ route('nilaisumatif.index') }}"
