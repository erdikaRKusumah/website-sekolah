                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            {{-- <span class="info-box-number">{{ $jumlah_ekstrakulikuler_diampu }} <small>ekstrakulikuler
                                    diampu</small></span> --}}
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                                    ...
                                    <table class="table table-bordered">
                                        <thead class="bg-success">
                                            <tr>
                                                ...
                                                <th colspan="4" class="text-center" style="width: 200px;">Jumlah
                                                    Perencanaan</th>
                                                <th rowspan="2" class="text-center" style="width: 100px;">Bobot</th>
                                                <th colspan="4" class="text-center" style="width: 200px;">Jumlah
                                                    Penilaian</th>
                                                <th colspan="2" class="text-center" style="width: 200px;">Input Nilai
                                                </th>
                                    ...
                                    <table class="table table-bordered">
                                        <thead class="bg-success">
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center" style="width: 50px;">KKM</th>
                                                <th rowspan="2" class="text-center" style="width: 100px;">Bobot</th>
                                                <th colspan="4" class="text-center" style="width: 200px;">Input Nilai
                                                </th>
                                                <th colspan="2" class="text-center" style="width: 100px;">Status Nilai
                                                    Raport</th>
                                            </tr>
                                            ...
                                            <div>
                                                ...
                                                <div class="timeline-item">
                                                    <span class="time"><i class="far fa-clock"></i>
                                                        {{ $pengumuman->created_at }}</span>

                                                    <h3 class="timeline-header"><a
                                                            href="#">{{ $pengumuman->user->admin->nama_lengkap }}</a>
                                                        {{ $pengumuman->judul }} @if ($pengumuman->created_at != $pengumuman->updated_at)
