                    ...
                    <div class="card-body">
                        <form method="post" action="/dashboard/galleries/{{ $gallery->id }}" class="mb-5" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" description="description" required autofocus value="{{ old('description', $gallery->description ) }}">
                                @error('description')
                            ...
                            <div class="mb-3">
                                ...
                                @if($gallery->image)
                                    <img src="{{ asset('storage/' . $gallery->image) }}" class="img-preview img-fluid mb-3 col-sm-5">
                                @else
